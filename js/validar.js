...
if(one){
    ...
    formulario.addEventListener('submit',(e) => {
        ...
        // console.log("El cuerpo es: " + textCuerpo);
        ...
        if(dato1 && dato2 && dato3 && dato4 && dato5 && dato6 && cuerpo){
            ...
            fetch('../agregar/datosRecibidos.php',{
                ...
                if(data == "repetido"){
                    ...
                    alert("El libro ha sido agregado exitosamente. Por favor agregue su genero y autor a continuación.");
